---
name: agent-toolkit/c4-architecture
description: >
  Generate architecture documentation using C4 model Mermaid diagrams. Use when asked to create
  architecture diagrams, document system architecture, visualize software structure, or generate
  C4 diagrams at any level. Triggers include "architecture diagram", "C4 diagram", "system context",
