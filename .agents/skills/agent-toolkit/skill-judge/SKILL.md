---
name: agent-toolkit/skill-judge
description: >
  Evaluate, score, and improve SKILL.md files and skill packages against official specifications and
  best practices. Use when asked to "evaluate this skill", "review my SKILL.md", "audit this skill",
  "score this skill", "how can I improve this skill?", or "is this skill well-designed?". Measures
  knowledge delta, structural compliance, anti-pattern quality, freedom calibration, and usability
  across 8 dimensions (120 points total). Produces a structured report with grade and improvements.
---
